...
var PatientServiceObj = new PatientService();
let Validator = require('validatorjs');
const { ObjectId } = require('mongodb');
var patientsImagePath = require('../config/config').patientsImagePath;

module.exports = class PatientsController {

    constructor() {}

    getAll( req, res, next ) {
        try {
            PatientServiceObj.getAll( req, res, next, function( err, result ) {
                ...
                if( err ) {
                    ...
                    return res.send({
                        ...
                        msg: 'Records found',
                        data: result,
                        patientsImagePath: patientsImagePath
                    });
                }
            } );
        } catch(ex) {
    ...
    getById( req, res, next ) {
        try {
            ...
            PatientServiceObj.getById( req, res, next, function( err, result ) {
    ...
    update( req, res, next ) {
        try {
            ...
            PatientServiceObj.update( req, res, next, function( err, result ) {
                if( err ) {
                    return res.send({
                        status: 400,
                        code: 400,
    ...
    delete( req, res, next ) {
        try {
            ...
            PatientServiceObj.delete( req, res, next, in_data, function( err, result ) {
                if( err ) {
                    return res.send({
                        status: 400,
                        code: 400,
    ...
    uploadProfilePic( req, res, next ) {
        try {
            ...
            PatientServiceObj.updateProfilePic( in_data, id, function( err, result ) {
                if( err ) {
                    return res.send({
                        status: 400,
                        code: 400,
